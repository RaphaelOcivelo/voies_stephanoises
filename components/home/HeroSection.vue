        ...
        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          >
            <h1>
              ...
              >
                <span class="block text-gray-900">Avancement de</span>
            ...
            >
              Une initiative des associations <strong>{{ assoName }}</strong> pour suivre le développement du nouveau réseau vélo de la métropole Stéphanoise et les environs.
            </p>
            <div
